        ...
        <div className="fixed inset-0 z-[100] bg-black/70 backdrop-blur-md">
          <div className="ml-auto h-full w-[85%] max-w-sm bg-[#070A12] p-6 shadow-2xl">
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => setOpen(false)} className="rounded-full bg-white p-2 text-black">
                <X />
              </button>
            </div>

            <div className="mt-10 flex flex-col gap-4">
              <button onClick={toggleTheme} className="rounded-2xl bg-yellow-400 px-5 py-4 font-black text-black">
              ...
              <a className="rounded-2xl bg-white/10 px-5 py-4 text-white" href="/#social">Social Media</a>
            </div>
          </div>
        </div>
      )}
